...
(function(factory){
  ...
  , showPreview: function() {
      ...
      var bugsAjax = function () {
        var tmp = null;
        $.ajax({
          async: false,
          url: '/bugs/preview',type: 'POST',
          dataType: 'html',
      ...
      replacementContainer.html(bugsAjax);
        ...
        data: [{
          ...
          callback: function(e){
            ...
            if (link !== null && link !== '' && link !== 'http://' && urlRegex.test(link)) {
              ...
              // transform selection and set the cursor into chunked text
              e.replaceSelection('!['+chunk+']('+sanitizedLink+' "'+e.__localize('')+'")');
              cursor = selected.start+2;

              // Set the next tab
              e.setNextTab(e.__localize(''));
